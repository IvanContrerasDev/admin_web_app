...
| C-16 / §16 Revisión registro | F-006 | NONE/PENDING/APPROVED/REJECTED/MANUAL_LOADED distintos; GPS causa PENDING; rechazado visible, destacado, editable y aprobable tras corrección | U/C transiciones; I separar revisión de datos; P-04.B |
| C-17 / §17 Origen | F-006 | Todo automático → AUTOMATIC; algún intervalo manual → MANUAL; resolver observación general sin marcar arbitrariamente intervalos | U/I mezclas de origen y política P-04.B |
| C-18 / §18 Intervalos | F-006 | Tipo/extremos/estado/revisión/origen/observaciones/metadata separados; ID persistido para editar sin duplicar | U DTOs; C edición y campos null; P-04.A/C |
...
| C-22 / §22 Revisión intervalo | F-006 | NONE/PENDING/APPROVED/REJECTED sin MANUAL_LOADED; independiente de completitud | U/C CLOSED + PENDING; I operación/efecto global pendiente P-04.B |
...
| C-25 / §25 Edición | F-006 | Abrir celda por doble clic o alternativa accesible; editar individual, agregar intervalos, crear registro completo; conflictos y cambios sin guardar | C/B teclado, formulario y cancelación; I unicidad/versión/validación; P-01/P-04.A/B |
| C-26 / §26 No borrar | F-006, F-010 | Sin eliminación de registros; corregir, no borrar; sin borrar intervalos persistidos por omisión | C ausencia de acción; I prohibiciones; P-04.A |
